...
<?= $this->section('title') ?>
<title>Dashboard | Bali Mode On</title>
<?= $this->endSection() ?>
                    ...
                    <div class="row pb-2">
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="<?= base_url() ?>/template/assets/img/avatar/avatar-5.png" class="img-fluid" data-toggle="tooltip" title="Alfa Zulkarnain">
                                <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="<?= base_url() ?>/template/assets/img/avatar/avatar-4.png" class="img-fluid" data-toggle="tooltip" title="Egi Ferdian">
                                <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="<?= base_url() ?>/template/assets/img/avatar/avatar-1.png" class="img-fluid" data-toggle="tooltip" title="Jaka Ramadhan">
                                <div class="avatar-badge" title="Author" data-toggle="tooltip"><i class="fas fa-pencil-alt"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="<?= base_url() ?>/template/assets/img/avatar/avatar-2.png" class="img-fluid" data-toggle="tooltip" title="Ryan">
                                <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="summary">
                        ...
                        <div class="summary-item">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50" src="<?= base_url() ?>/template/assets/img/products/product-1-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50" src="<?= base_url() ?>/template/assets/img/products/product-2-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50" src="<?= base_url() ?>/template/assets/img/products/product-3-50.png" alt="product">
                                    </a>
                                    <div class="media-body">
